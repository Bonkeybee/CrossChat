...
DUNGEON_REGEX_TBC = 'hr|hfr|ramps*|ramparts*|bf|blood|furnace|sh|shattered|halls*|citadel|sp|slave|pens*|slavepens*|ub|underbog|sv|steamvaults*|cfr|mt|mana|tombs*|ac|crypts*|seth|sethekk*|halls*|sl|shadow|labs*|slabs*|bm|black|morass|blackmorass|oh|ohb|dh|dk|ohf|durn|old|hillsbrad|foothills*|arc|arcatraz|bot|botanica|mech|mechanar|mgt|mrt|magisters*|terrace'
