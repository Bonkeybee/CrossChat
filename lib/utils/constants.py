...
DUNGEON_REGEX_VANILLA = 'rfc|wc|vc|dm|deadmines*|sfk|bfd|stockades*|stocks*|gnomer|gnomeregan|rfk|sm|scarlet|monastery|rfd|razorfen|razorfen downs|uld|ulda|uldaman|zf|mara|maraudon|princess|st|sunken|temple|brd|lbrs|ubrs|dme|dmw|dmn|dire|diremaul|scholo|scholomance|strat|strath|dungeon'
...
DUNGEON_REGEX_TBC = 'hfr|ramps*|ramparts*|bf|blood furnace|citadel|cfr|underbog|ub|slave pens|sp|mana tombs'
