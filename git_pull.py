...
WOW_LFGCHATLOGGER_PATH = ADDON_PATH + constants.BACK_SLASH + constants.LFGCHATLOGGER_ADDON
SRC_LFGCHATLOGGER_PATH = constants.ADDONS + constants.BACK_SLASH + constants.LFGCHATLOGGER_ADDON
update_addon(SRC_LFGCHATLOGGER_PATH, WOW_LFGCHATLOGGER_PATH)
