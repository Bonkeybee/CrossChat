...
DUNGEON_REGEX_VANILLA = 'rfc|wc|vc|dm|deadmines*|sfk|bfd|stockades*|stocks*|gnomer|gnomeregan|rfk|sm|scarlet|monastery|rfd|uld|ulda|uldaman|zf|mara|maraudon|princess|st|sunken|temple|brd|lbrs|ubrs|dme|dmw|dmn|dire|diremaul|scholo|scholomance|strat|strath|dungeon'
RAID_REGEX_VANILLA = 'mc|molten|ony|onyxia|zg|zul|gurub|bwl|blackwing|aq|ahn\'qirah|aq20|aq40|naxx|naxxramas|lair'
DUNGEON_REGEX_TBC = 'hfr|ramps*|ramparts*|bf|blood|furnace|citadel|slave|pens|sp'
