...
print('copying ' + constants.GUILDCHATLOGGER_ADDON + ' to ' + ADDON_PATH + constants.BACK_SLASH + constants.GUILDCHATLOGGER_ADDON)
...
print('copying ' + constants.OFFICERCHATLOGGER_ADDON + ' to ' + ADDON_PATH + constants.BACK_SLASH + constants.OFFICERCHATLOGGER_ADDON)
