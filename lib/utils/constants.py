...
DUNGEON_REGEX_TBC = 'hr|hfr|ramps*|ramparts*|bf|blood|furnace|citadel|cfr|underbog|ub|slave|pens*|slavepens*|sp|mt|mana|tombs*|ac|crypts*|bm|black|morass|ohf|old|hillsbrad|foothills*|sethekk*|halls*|shadow|labs*|slabs*|steamvaults*|arcatraz'
