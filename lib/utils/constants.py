...
LFG_PATTERN = re.compile('.*(lf|lfm|lfg|looking|any|anyone|need|tank[s]*|heal[s]*|healer[s]*|dps|druid|hunter|mage|paladin|priest|rogue|shaman|warlock|warrior).*( )([/]*(whatever|any|tank[s]*|heal[s]*|healer[s]*|dps|pvp|lf|lfm|lfg|looking|mara|diremaul|zg|zf|rfd|bfd|ubrs|lbrs|uld|ulda|aq|aq20|aq40|st|brd|sfk|sm|dm|deadmine[s]*|stockade[s]*|stock[s]*|gnomer|gnomeregan|strat|scholo|scholomance|dungeon)[/]*\\b).*', re.IGNORECASE)
