...
LFG_PATTERN = re.compile('.*(lf|lfm|lfg|looking|any|anyone|need|tank[s]*|heal[s]*|healer[s]*|dps).*( )([/]*(whatever|any|tank[s]*|heal[s]*|healer[s]*|dps|pvp|lf|lfm|lfg|looking|mara|zg|zf|rfd|bfd|ubrs|lbrs|ulda|aq|aq20|aq40|st|brd|sfk|sm|dm|deadmine[s]*|stockade[s]*|stock[s]*|gnomer|gnomeregan|strat|scholo|scholomance|dungeon)[/]*\\b).*', re.IGNORECASE)
