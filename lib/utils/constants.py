...
LFG_PATTERN = re.compile('.*(lf|lfm|lfg|looking|any|anyone|need|tank[s]*|heal[s]*|dps).*( ).*([/]*(tank[s]*|heal[s]*|healer[s]*|dps|pvp|mara|zg|zf|ubrs|lbrs|aq|aq20|aq40|st|brd|sfk|sm|dm|deadmine[s]*|stockade[s]*|stock[s]*|gnomer|gnomeregan|strat|scholo|scholomance|dungeon)\\b).*', re.IGNORECASE)
